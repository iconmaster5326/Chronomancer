...
M.fV.prototype={}
Z.hK.prototype={
u:function(){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5,b6,b7,b8,b9,c0,c1,c2,c3,c4,c5,c6,c7,c8,c9,d0,d1,d2=this,d3="h3",d4="ul",d5="li",d6=d2.a6(),d7=document,d8=T.m(d7,d6)
d2.f=d8
d2.k(d8,"modal fade")
T.r(d2.f,"id","changelog-dialog")
T.r(d2.f,"role","dialog")
d8=d2.f;(d8&&C.e).sb8(d8,-1)
d2.j(d2.f)
d2.e=O.bN()
s=T.m(d7,d2.f)
d2.k(s,"modal-dialog modal-dialog-centered")
T.r(s,"role","document")
d2.j(s)
r=T.m(d7,s)
d2.k(r,"modal-content bordered")
d2.j(r)
q=T.m(d7,r)
d2.k(q,"modal-header")
d2.j(q)
...
m=T.t(d7,p,d5)
d2.A(m)
T.o(m,"Added a long-requested feature: Importing from save files! Use the upper-right-hand import ment to import your saves. On Windows, your save files can be found at ")
l=T.t(d7,m,"code")
d2.A(l)
T.o(l,"%localappdata%\\Chronicon\\save")
T.o(m,".")
k=T.t(d7,p,d5)
d2.A(k)
T.o(k,"Fixed the behavior of Weyrick's Finery and Ring of Marvellous Gems with regard to enchantment-based sockets.")
j=T.t(d7,p,d5)
d2.A(j)
T.o(j,"Fixed an issue where Heatwall had a missing sprite.")
i=T.t(d7,o,d3)
d2.A(i)
T.o(i,"v1.6.0")
p=d8.a(T.t(d7,o,d4))
...
h=T.t(d7,p,d5)
d2.A(h)
T.o(h,"Update to the latest Tinka build (1.30.0).")
g=T.t(d7,p,d5)
d2.A(g)
T.o(g,"Skills now have cooldown and tag information available (version 1.30.0 only).")
f=T.t(d7,p,d5)
d2.A(f)
T.o(f,"Tally skills for masteries now show up in the skill UI (version 1.30.0 only).")
e=T.t(d7,o,d3)
d2.A(e)
T.o(e,"v1.5.4")
p=d8.a(T.t(d7,o,d4))
...
d=T.t(d7,p,d5)
d2.A(d)
T.o(d,"Added a confirmation dialog when you try to reset a character. No more accidentally lost builds!")
c=T.t(d7,p,d5)
d2.A(c)
T.o(c,"Implemented the special behavior in the Ring of Marvellous Gems. I've only seen them generate with 2 gems, so if they can generate with more or less gems, please let me know.")
b=T.t(d7,p,d5)
d2.A(b)
T.o(b,"Added search functionality when picking out items and enchantments.")
a=T.t(d7,o,d3)
d2.A(a)
T.o(a,"v1.5.3")
p=d8.a(T.t(d7,o,d4))
...
a0=T.t(d7,p,d5)
d2.A(a0)
T.o(a0,"Added rune information for the new unique enchantments, so you can now add those newly introduced runes to your equipment.")
a1=T.t(d7,o,d3)
d2.A(a1)
T.o(a1,"v1.5.2")
p=d8.a(T.t(d7,o,d4))
...
a2=T.t(d7,p,d5)
d2.A(a2)
T.o(a2,"Added content from 1.11.3 and 1.20.2. Do note that 2 item images are not present yet, and the new dropped runes do not yet have slot information.")
a3=T.t(d7,o,d3)
d2.A(a3)
T.o(a3,"v1.5.1")
p=d8.a(T.t(d7,o,d4))
...
a4=T.t(d7,p,d5)
d2.A(a4)
T.o(a4,"Fixed some innacuracies regarding enchantments in 1.10.8.")
a5=T.t(d7,o,d3)
d2.A(a5)
T.o(a5,"v1.5.0")
p=d8.a(T.t(d7,o,d4))
...
a6=T.t(d7,p,d5)
d2.A(a6)
T.o(a6,"Added partial cooldown information. Some skills still lack cooldown information; we're working on adding full cooldown information to the dataset ASAP.")
a7=T.t(d7,o,d3)
d2.A(a7)
T.o(a7,"v1.4.0")
p=d8.a(T.t(d7,o,d4))
...
a8=T.t(d7,p,d5)
d2.A(a8)
T.o(a8,"Added mana cost and skill family to skill tooltips. Note that the current dataset does not yet contain cooldown or skill tag information; I hope to fix that soon.")
a9=T.t(d7,p,d5)
d2.A(a9)
T.o(a9,"Added the concept of item and character level. Note that item level currently does not correctly affect the values of base enchantments (that is: health, mana, damage).")
b0=T.t(d7,p,d5)
d2.A(b0)
T.o(b0,"Fixed issue where you could put multiple of the same enchant on an item.")
b1=T.t(d7,p,d5)
d2.A(b1)
T.o(b1,"Fixed the favicon being the default angular.js one.")
b2=T.t(d7,p,d5)
d2.A(b2)
T.o(b2,"Fixed issue with item enchant colors not rendering correctly after loading from a build.")
b3=T.t(d7,o,d3)
d2.A(b3)
T.o(b3,"v1.3.0")
p=d8.a(T.t(d7,o,d4))
...
b4=T.t(d7,p,d5)
d2.A(b4)
T.o(b4,"Added the ability to generate a link to the builds you make. They are not permalinks; they will not reflect changes you make after you get the link to the build!")
b5=T.t(d7,o,d3)
d2.A(b5)
T.o(b5,"v1.2.0")
p=d8.a(T.t(d7,o,d4))
...
b6=T.t(d7,p,d5)
d2.A(b6)
T.o(b6,"Added build importing and exporting. Right now it only imports and exports to a format local to Chronomancer; importing from Chronicon save files is a planned feature.")
b7=T.t(d7,p,d5)
d2.A(b7)
T.o(b7,"The build you're currently working on will now be automatically saved and brought back up when reloaded.")
b8=T.t(d7,o,d3)
d2.A(b8)
T.o(b8,"v1.1.0")
p=d8.a(T.t(d7,o,d4))
...
b9=T.t(d7,p,d5)
d2.A(b9)
T.o(b9,"Added this changelog.")
c0=T.t(d7,p,d5)
d2.A(c0)
T.o(c0,"Added a loading screen.")
c1=T.t(d7,p,d5)
d2.A(c1)
T.o(c1,"Item sets now show up in tooltips.")
c2=T.t(d7,p,d5)
d2.A(c2)
T.o(c2,"The item selection dialog is now more concise, and indicates when an item is part of a set.")
c3=T.t(d7,p,d5)
d2.A(c3)
T.o(c3,"The Chronicon font should now render on any browser that doesn't install TTF fonts from Internet sources. (Which should be all of the browsers.)")
c4=T.t(d7,p,d5)
d2.A(c4)
T.o(c4,"You can now ctrl-click as well as shift-click elements. Sorry, Firefox users, for making you unable to clear selected skills there.")
c5=T.t(d7,o,d3)
d2.A(c5)
T.o(c5,"v1.0.1")
p=d8.a(T.t(d7,o,d4))
...
c6=T.t(d7,p,d5)
d2.A(c6)
T.o(c6,"Fixed rendering issues on Firefox.")
c7=T.t(d7,p,d5)
d2.A(c7)
T.o(c7,"Fixed some broken skill tooltips.")
c8=T.t(d7,p,d5)
d2.A(c8)
T.o(c8,"Items that have a base quality of Enchanted may now be generated at either Enchanted or Rare quality.")
c9=T.t(d7,o,d3)
d2.A(c9)
T.o(c9,"v1.0.0")
p=d8.a(T.t(d7,o,d4))
...
d0=T.t(d7,p,d5)
d2.A(d0)
T.o(d0,"Initial release.")
d1=T.m(d7,r)
d2.k(d1,"modal-footer")
d2.j(d1)
d8=d8.a(T.t(d7,d1,"button"))
d2.k(d8,"btn short-button")
T.r(d8,"data-dismiss","modal")
T.r(d8,"type","button")
d2.j(d8)
T.o(d8,"Close")
d8=t.z
d2.aG(H.f([d2.e.b.as(d2.T(d2.gkO(),d8,d8))],t.h))},
v:function(){var s=this.d.f
if(s===0)this.e.a.n(0,null)},
